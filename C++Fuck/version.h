...
#define PRODUCTNAME "C++Fuck"
#define ORIGINALNAME PRODUCTNAME ".exe" // Same as internal name.
#define COPYRIGHT "NotnHeavy, since 2021"
...
#define FTYPE VFT_APP // For DLLs, do VFT_DLL.
