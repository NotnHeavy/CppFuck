...
namespace CppFuck
{
	...
	// OptimiseMemoryCopying: Toggle between robustness (bit shifts) and speed (memcpy) for copying integral values from bytecode to memory. Uses memcpy by default.
